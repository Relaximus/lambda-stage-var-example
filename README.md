...
```bash
$ mvn archetype:generate -DartifactId=spring-lambda -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-spring-archetype -DarchetypeVersion=1.3 -DgroupId=com.relaximus.example -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd spring-lambda
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "SpringLambdaApi",
                    "OutputKey": "SpringLambdaApi",
